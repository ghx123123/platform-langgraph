...
export const AGENT_ROLE_DEFINITIONS: AgentRoleDefinition[] = [
  ...
  { key: 'teach', name: '课程教师 Agent', role: '讲授与答疑角色', responsibility: '统一负责课堂讲授、追问、反馈与答疑', input: 'Lesson Blueprint · 课堂事件', output: '讲授、反馈、答疑动作', kind: 'teacher', phase: 'teach_knowledge', icon: GraduationCap },
